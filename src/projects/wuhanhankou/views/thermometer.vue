      ...
      <div class="table-area">
        ...
        <div class="info-box">
          ...
          >
            ...
            <div class="item temp">
              ...
              <div
                class="pain-area"
                :style="`height: ${painAreaHeight - 15}px`"
              >
        ...
        <div class="table-box" style="transform: translateY(-0.5px);">
          <div
            ...
            :key="item"
          ></div>
          <div class="row font-14 border-top-red-2" :style="{ height: `${trHeight + 20}px` }">
            <div
              class="label"
              :style="{
                width: `${leftWidth}px`,
        ...
        if (['01', '043', '041'].includes(vitalCode)) {
          ...
          if (index > 0) {
            ...
            const list = [
              ...
              {
                vitalCode: '200',
                ...this.settingMap.earTemperature.data[0],
              },
              {
                vitalCode: '01',
