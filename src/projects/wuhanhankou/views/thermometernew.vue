<template>
  ...
  >
    ...
    <div class="table-area">
      ...
      <div
        class="vline"
        :style="{ right: '1px', borderLeft: '2px solid #000' }"
      ></div>
      <div class="table-box" style="transform: translateY(0.5px);">
        ...
        <div class="row" :style="{ height: `${trHeight}px` }">
          <div class="label" :style="{ width: `${leftWidth}px` }">
            <span class="time-label" v-html="`时&emsp;&emsp;间`"></span>
          </div>
      ...
      <div class="info-box">
        ...
        >
          ...
          <div class="item times">
            <div class="text" style="flex: none;">
          ...
          <div class="item temp">
            <div class="text" style="flex: none;">
              <div class="p-r-5" style="color: red;">体温</div>
      ...
      <div class="table-box" style="transform: translateY(-0.5px);">
        <div class="row font-14" :style="{ height: `${trHeight + 20}px` }">
          <div
            class="label"
...
import { mockData } from 'src/projects/wuhanhankou/mockData.js'
  ...
  methods: {
      ...
      if (e && e.data) {
        switch (e.data.type) {
          ...
          case 'dateChangePage':
            ...
            break
          case 'resizePage':
            if (e.data.value) this.getIinnerWidth = e.data.value
            break
          default:
            break
        }
    ...
    createNote(notes, y, color) {
      ...
      notes.forEach((x, i) => {
        ...
        this.createText({
          ...
          x: xaxisNew[i],
          y: bottomText.includes(value) ? this.timesTempAreaHeight - 3 : y,
    ...
    yLine() {
      ...
      for (let i = 0; i < totalLine; i++) {
        const isBreak = i % 5 === 0 && i > 0 && i < totalLine - 1 && i !== 25
        const isboundary = i == 25
        const lineWidth = isBreak || isboundary ? 3 : 2
        const params = {
          x1: 0,
          y1: preSpace,
          x2: this.areaWidth - 1,
          y2: preSpace,
          lineWidth,
          color: isBreak ? '#000' : isboundary ? 'red' : '#000',
        }
