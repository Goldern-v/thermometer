<template>
  <div
    ...
    @dblclick="dblclick"
  >
    <div class="head-hos" @click="() => {}">松桃苗族自治区人民医院</div>
    ...
    <div class="table-area">
      ...
      <div class="table-box" style="transform: translateY(-0.5px)">
        ...
        <div class="row" :style="{ height: `${trHeight}px` }">
          <div class="label" :style="{ width: `${leftWidth}px` }">分娩</div>
          <div class="value-item-box">
            <div
              class="value-item"
        ...
        <div class="row" :style="{ height: `${trHeight}px` }">
          <div class="label" :style="{ width: `${leftWidth}px` }">过敏药物</div>
          <div class="value-item-box">
            <div
              class="value-item"
...
export default {
  ...
  mounted() {
    ...
    console.log(this.$route,98765456)
