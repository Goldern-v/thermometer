<template>
  ...
  >
    <div class="head-hos">珠海市中西医结合医院</div>
...
import { mockData } from "src/projects/zhzxy/mockData.js";
...
export default {
  ...
  computed: {
    ...
    timesTempAreaHeight() {
      return (
        this.areaHeight -this.bottomAreaHeight
      );
    },
    formatBreatheList() {
      const timeNumRange = this.timeRange.map((x) => this.getTimeNum(x));
  ...
  methods: {
    ...
    getAreaHeight() {
      const totalLine =
        ...
        this.yRange[0] +
        1 +
        (this.yRange[1] - this.yRange[0]) * 4 -3;
      let preSpace = 0;
      for (let i = 0; i < totalLine; i++) {
